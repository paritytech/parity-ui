...
$ npm run dev
```
* If you're developing Inject page, please allow `https://localhost:3030` connections. (Because `injectpage` injected GitHub (https) pages, so webpack server procotol must be https.)
